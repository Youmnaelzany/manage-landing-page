...
const TheyHaveSaid = () => {
  return (
    <Wrapper className="flex flex-col items-center justify-center gap-10 pt-28 pb-21.5 md:gap-16 md:pt-24 md:pb-24 lg:pt-44 lg:pb-36">
        ...
        >
          <CarouselContent className="-ml-4">
            {testimonial.map((item) => (
              <CarouselItem
                className="pl-4 md:basis-1/2 md:pl-6"
                key={item.id}
              >
